...
*pedidos dos clientes e retornar as respostas do serviço.
*/

class serverImp final : public opVet::Service{
...
public:
	...
	* única resposta. Usamos o método Reader(Read) para ler repetidamente
...
* Para inicializar o serviço precisamdos de um objeto da classe ServerBuilder
*/
...
void RunServer() {
	...
	cout << "Servidor está escutando" << server_address << std::endl;
